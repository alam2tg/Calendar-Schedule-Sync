...
function Header () {
    ...
    return (
      ...
      <Navbar bg='light' className='header'>
        <Container fluid>
          <Navbar.Brand className='nav-item' style={{color:'black', fontSize:'24px'}} as={Link} to='/'>
            BACK TO LANDING
          </Navbar.Brand>
          ...
          <Navbar.Collapse id='navbar' className='d-flex flex-row-reverse'>
            <Nav className='ml-auto d-flex'>
              ...
              {Auth.loggedIn() ? (
                ...
                <Nav.Link className='nav-item' style={{color:'black', fontSize:'24px'}} onClick={() => setShowModal(true)}>LOG IN / SIGN UP</Nav.Link>
              )}
            </Nav>
          </Navbar.Collapse>
        </Container>
